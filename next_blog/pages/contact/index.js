...
const Contact = () => {
  return (
    <div className="mt-10 flex flex-col items-center justify-center lg:px-40 px-10 bg-white dark:bg-gray-900 w-screen text-black dark:text-white">
      ...
      <div className='m-2 text-center justify-center w-full md:w-3/6'>
        ...
        <button className='border border-solid border-pink-600 p-2 mt-2 pulse hover:bg-pink-500 hover:scale-105 transform bg-pink-600 font-mono uppercase text-sm text-white'>Send message</button>
      </form>
    </div>
  )
}
